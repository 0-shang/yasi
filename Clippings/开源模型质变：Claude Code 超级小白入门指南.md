...
source: "https://x.com/oran_ge/status/2005419365450252425"
author:
  - "[[@oran_ge]]"
published: 2025-12-28
created: 2026-05-17
description: "两个月以来，我一直想写一篇给小白的 CC 入门指南，今天终于可以写了。Claude Code （简称 CC）是我今年最推荐的 AI 产品，没有之一。Claude Code 虽然叫 Code，但它的功能绝对不止是写代码，而是一款真正意义上的通用 Agent。很多电脑上的很繁琐的工作..."
tags:
  - "clippings"
---
![图像](https://pbs.twimg.com/media/G9SseS2bkAAF2y3?format=jpg&name=large)

两个月以来，我一直想写一篇给小白的 CC 入门指南，今天终于可以写了。

Claude Code （简称 CC）是我今年最推荐的 AI 产品，没有之一。

Claude Code 虽然叫 Code，但它的功能绝对不止是写代码，而是**一款真正意义上的通用 Agent。**
...
![图像](https://pbs.twimg.com/media/G9SsT9bbMAAh9AY?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9SspcMbAAAaA4M?format=png&name=large)
...
2. 到这里安装最新版本的 Node.js ，地址： [https://nodejs.org/en/download/](https://nodejs.org/en/download/)

3. Windows 用户还需要额外安装 Git for Windows，地址：[https://git-scm.com/install/windows](https://git-scm.com/install/windows)

## 二、正式开始安装 CC

1. 在你的电脑上，搜索「终端」，打开它，是这样的，不用害怕，你就把它理解成一个界面很酷的 AI 对话框。

![图像](https://pbs.twimg.com/media/G9Ss5uhakAIBOeT?format=jpg&name=large)

2. 在终端里，粘贴下面的命令，然后回车。 npm install -g [@anthropic](https://x.com/@anthropic)\-ai/claude-code
...
![图像](https://pbs.twimg.com/media/G9StBi7bQAASDDq?format=png&name=large)
...
{ // ... 其他配置 "hasCompletedOnboarding": true }
...
1. 注册账号。访问 **智谱开放平台**（[https://open.bigmodel.cn/](https://open.bigmodel.cn/)），点击右上角的「注册/登录」按钮，按照提示完成账号注册流程。

2. 获取API Key。在个人中心页面，点击 **API Keys**（[https://bigmodel.cn/usercenter/proj-mgmt/apikeys](https://bigmodel.cn/usercenter/proj-mgmt/apikeys)）创建一个新的 API Key，复制下来备用。

3. **订阅一个 Coding 套餐**，用了套餐之后，可以尽情使用，再也不用担心账号欠费背刺。

现在有个跨年特惠，强烈推荐这个包季的 Coding Lite，三个月只要 54 块钱，跟不要钱一样。

可以在这里购买：[https://www.bigmodel.cn/glm-coding?ic=KSGMCBOXUT](https://www.bigmodel.cn/glm-coding?ic=KSGMCBOXUT)

![图像](https://pbs.twimg.com/media/G9StGD2aoAAjgp4?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9StKdQawAAIAFx?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9StPZxbYAAVWKg?format=jpg&name=large)

说个你好，打个招呼吧！

从此以后，这就是你的万能的助手。

你可能不习惯这种打开方式，没关系，可以安装我写的启动器 Claude Code Now，在这里安装 [https://claudecodenow.com/](https://claudecodenow.com/)

安装之后，在你的任意文件夹里，都可以看到 Claude Code，点击一下，就能启动了，超级方便。

![图像](https://pbs.twimg.com/media/G9StStPaQAA7kO9?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9StceqaIAAKN4a?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9Stk5gbkAANTcL?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9StrdLaMAAu-GY?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/G9StuHoaQAABNfE?format=jpg&name=large)
...
<video preload="none" tabindex="-1" playsinline="" aria-label="嵌入式视频" poster="https://pbs.twimg.com/amplify_video_thumb/2005418931868303361/img/aJ6bEIzArKgqnzg1.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/70a7020c-cd28-40a2-8702-699befbbf835"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2005418931868303361/img/aJ6bEIzArKgqnzg1.jpg?name=large)
...
你可以直接从现有的 Skill 网站里 copy，也可以让 CC 自己创建，这是官方的 Skill 指南 [https://github.com/anthropics/skills](https://github.com/anthropics/skills)

Skill 的具体使用也非常简单，比如今天刚好看到刘小排老师发的前端设计 Skill (刘小排老师是 CC 之神，大家可以关注他的公众号学习更多技巧）

先用一句话安装 Skill

npx skills-installer install [@anthropics/claude-code](https://x.com/@anthropics/claude-code)/frontend-design --client claude-code

然后跟 CC 说：

使用 [@anthropics/skills](https://x.com/@anthropics/skills)/frontend-design skill，重新设计 [https://listenhub.ai](https://listenhub.ai/) 的首页

![图像](https://pbs.twimg.com/media/G9SuFGnbcAAjYJl?format=jpg&name=large)

得到的结果是这样的，非常高级，完全没有 AI 设计网页的默认蓝紫色。

![图像](https://pbs.twimg.com/media/G9SuCTSagAArkqD?format=jpg&name=large)
